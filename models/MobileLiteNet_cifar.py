...
class MobileLiteNet(nn.Module):
    def __init__(self, n_class=2, input_size=32, se = False, avgdown=False, width_mult=1.):
...
def mobilelitenetA_cifar():
    model = MobileLiteNet(se = True,input_size = 32)
    return model

def mobilelitenetB_cifar():
    model = MobileLiteNet(se = True,input_size = 32,avgdown=True)
    return model
